...
acil = PRANKBOTS.LINE() 
acil.login(token="Ergb1ayWs7wftM9LXpYb.VKQ9Jq2o+6hoVXBJ0l/fgW.nBDXMYFOsT81oF2DOS38lTfdNZD+ahtD1bZ0yzbdpEE=")
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="1Erd1OKitpFBedyKsJfr0.to+5h/5iTjkqqWhYUKUCaa.Z8lcWTd6qk+aN0MYGAZRSo/+tOWk3EUXDqyHGB2dEjE=")
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="ErA4TigilryvFvqgXHS4.J0txq3n5jYXXSyfJRP0/9a.dyXjXjC4AFewHe/MDpijro/dfsBsWMfJSjWUkd3U9dc=")
pb2.loginResult()
